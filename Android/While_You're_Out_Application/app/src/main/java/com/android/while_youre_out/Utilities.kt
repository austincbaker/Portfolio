...
fun showReminderInMap(context: Context, map: GoogleMap, reminder: Reminder) {
    if (reminder.latLng != null) {
        ...
        val vectorToBitmap = vectorToBitmap(context.resources, R.drawable.ic_dropped_pin_24)
        ...
        if (reminder.radius != null) {
            ...
            map.addCircle(
                ...
                .fillColor(ContextCompat.getColor(context, R.color.radiusFill)))
        }
    }
}
...
fun sendNotification(context: Context, message: String, latLng: LatLng) : Int {
    ...
    val intent = CreateNewReminder.utilityIntent(context.applicationContext, latLng, 15f)

    val stackBuilder = TaskStackBuilder.create(context)
        .addParentStack(WhileYoureOut::class.java)
